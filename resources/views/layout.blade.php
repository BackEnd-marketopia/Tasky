...
<head>
    ...
    <link href="{{asset('assets/css/fullcalendar/list/main.css')}}" rel="stylesheet" />
       <script src="https://cdn.jsdelivr.net/npm/js-draw@1.24.2/dist/bundle.min.js"></script>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/js-draw@1.24.2/dist/Editor.min.css">
...
<body>
    ...
    $allowedFileTypes = isset($general_settings['allowed_file_types']) ? $general_settings['allowed_file_types'] : '.png,.jpg,.pdf,.doc,.docx,.xls,.xlsx,.zip,.rar,.txt';
