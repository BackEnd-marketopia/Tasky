...
class TasksController extends Controller
{
    ...
    public function index(Request $request, $id = '')
    {
        ...
        return view('tasks.tasks', ['project' => $project, 'tasks' => $tasks, 'is_favorites' => $is_favorites]);
    }
    /**
     * Create a new task.
     *
    ...
    public function show($id)
    {
        ...
        return view('tasks.task_information', ['task' => $task, 'auth_user' => $this->user,'project' => $project ]);
    }
    ...
    public function dragula(Request $request, $id = '')
    {
        ...
        return view('tasks.board_view', ['project' => $project, 'tasks' => $tasks, 'total_tasks' => $total_tasks, 'is_favorites' => $isFavorites]);
    }
    ...
    public function calendar(Request $request, $id = null)
    {
        ...
        return view('tasks.calendar_view', ['project' => $project, 'is_favorites' => $isFavorites]);
    }
     ...
     public function group_by_task_list(Request $request)
    {
        try {
            ...
            return view('tasks.group_by_task_lists', compact('taskLists', 'projects', 'tasks', 'toSelectTaskUsers','is_favorites'));
        } catch (\Exception $e) {
            // dd($e);
