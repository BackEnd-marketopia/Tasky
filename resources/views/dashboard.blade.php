...
@if (config('constants.ALLOW_MODIFICATION') === 0)
    ...
    <div role="alert" class="alert alert-warning container mb-0 mt-4  alert-dismissible">
     <span class=" fw-semibold py-2">
        <i class="bx bx-timer me-2 bx-md"></i>
        Important: Data automatically resets every 24 hours !
     </span>
...
@endif
            ...
            <div class="col-lg-3 col-md-6 col-6 mb-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex align-items-start justify-content-between">
                        ...
                        <div class="avatar">
                            <span class="avatar-initial rounded {{ $tile['icon-bg'] }}">
    ...
    <div class="nav-align-top">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <button type="button" class="nav-link parent-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-upcoming-birthdays" aria-controls="navs-top-upcoming-birthdays" aria-selected="true">
            ...
            <li class="nav-item">
                <button type="button" class="nav-link parent-link @if(isset($general_settings['upcomingBirthdays']) && $general_settings['upcomingBirthdays'] != 1) active @endif" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-upcoming-work-anniversaries" aria-controls="navs-top-upcoming-work-anniversaries" aria-selected="false">
                    <i class="menu-icon tf-icons bx bx-star text-warning"></i> <?= get_label('upcoming_work_anniversaries', 'Upcoming work anniversaries') ?>
                </button>
            </li>
            @endif
            @if (!isset($general_settings['membersOnLeave']) || $general_settings['membersOnLeave'] == 1)
            <li class="nav-item">
                <button type="button" class="nav-link parent-link @if(isset($general_settings['upcomingBirthdays']) && isset($general_settings['upcomingWorkAnniversaries']) && $general_settings['upcomingBirthdays'] != 1 && $general_settings['upcomingWorkAnniversaries'] != 1) active @endif" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-members-on-leave" aria-controls="navs-top-members-on-leave" aria-selected="false">
        ...
        <div class="tab-content">
                ...
                <ul class="nav nav-tabs justify-content-start gap-2 mb-3 rounded-pill" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button type="button"
                            ...
                            aria-controls="navs-top-upcoming-birthdays-list"
                            aria-selected="true">
                            <?= get_label('list', 'List') ?>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button type="button"
                            ...
                            aria-controls="navs-top-upcoming-birthdays-calendar"
                            aria-selected="false">
                ...
                <div class="tab-content no-shadow p-0">
                    <div class="tab-pane fade active show" id="navs-top-upcoming-birthdays-list" role="tabpanel">
                        ...
                        <div class="alert alert-primary alert-dismissible" role="alert">
                            ...
                            <a href="{{ url('users/edit/' . $auth_user->id) }}"><?= get_label('click_here_to_set_it_now', 'Click here to set it now') ?></a>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        @endif
            ...
            @endif
            @if (!isset($general_settings['upcomingWorkAnniversaries']) || $general_settings['upcomingWorkAnniversaries'] == 1)
            <div class="tab-pane fade @if(isset($general_settings['upcomingBirthdays']) && $general_settings['upcomingBirthdays'] != 1) active show @endif" id="navs-top-upcoming-work-anniversaries" role="tabpanel">
                <ul class="nav nav-tabs justify-content-start gap-2 mb-3 rounded-pill" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button type="button"
                            class="nav-link active rounded-2 px-4 py-2 bg-primary text-white list-button"
                            ...
                            aria-controls="navs-top-upcoming-work-anniversaries-list"
                            aria-selected="true">
                            <?= get_label('list', 'List') ?>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button type="button"
                            ...
                            aria-controls="navs-top-upcoming-work-anniversaries-calendar"
                            aria-selected="false">
                            <?= get_label('calendar', 'Calendar') ?>
                        </button>
                    </li>
                ...
                <div class="tab-content no-shadow p-0">
                    <div class="tab-pane fade active show" id="navs-top-upcoming-work-anniversaries-list" role="tabpanel">
                        @if (!$auth_user->doj)
                        <div class="alert alert-primary alert-dismissible" role="alert">
                            <?= get_label('doj_not_set_alert', 'Your DOJ is not set') ?>, <a href="{{ url('users/edit/' . $auth_user->id) }}"><?= get_label('click_here_to_set_it_now', 'Click here to set it now') ?></a>.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        @endif
            ...
            @endif
            @if (!isset($general_settings['membersOnLeave']) || $general_settings['membersOnLeave'] == 1)
            <div class="tab-pane fade @if(isset($general_settings['upcomingBirthdays']) && isset($general_settings['upcomingWorkAnniversaries']) && $general_settings['upcomingBirthdays'] != 1 && $general_settings['upcomingWorkAnniversaries'] != 1) active show @endif" id="navs-top-members-on-leave" role="tabpanel">
                <ul class="nav nav-tabs justify-content-start gap-2 mb-3 rounded-pill" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button type="button"
                            class="nav-link active rounded-2 px-4 py-2 bg-primary text-white list-button"
                            ...
                            aria-controls="navs-top-members-on-leave-list"
                            aria-selected="true">
                            <?= get_label('list', 'List') ?>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button type="button"
                            ...
                            aria-controls="navs-top-members-on-leave-calendar"
                            aria-selected="false">
                            <?= get_label('calendar', 'Calendar') ?>
                        </button>
                    </li>
    ...
    <div class="nav-align-top {{$auth_user->can('manage_users') && (!isset($general_settings['upcomingBirthdays']) || $general_settings['upcomingBirthdays'] == 1) || (!isset($general_settings['upcomingWorkAnniversaries']) || $general_settings['upcomingWorkAnniversaries'] == 1) || (!isset($general_settings['membersOnLeave']) || $general_settings['membersOnLeave'] == 1)?' mt-4':''}}">
        <ul class="nav nav-tabs" role="tablist">
            @if ($auth_user->can('manage_projects'))
            <li class="nav-item">
